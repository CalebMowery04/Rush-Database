function myFunction() {
  var rushSheetId = "1YHg87DU61wDlyKfBNbfAlmnwqYWG-GHe2Lvoh4E1WBU";
  ...
  for (var i = 1; i < data.length; i++) {
    ...
    // bro vote
    var broVoteTB = newRushSlide
    .insertTextBox("Brotherhood vote: " + rushRow[14], position.left, 160, 200, 30);

    makeTextBig(broVoteTB, 18);
    // gpa
