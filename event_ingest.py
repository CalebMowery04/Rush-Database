...
event_responses_filenames = [
    "real_data/BM24 Scoring Form 1 (Responses) - Form Responses 1.csv",
    "real_data/BM24 Scoring Form 2 (Responses) - Form Responses 1.csv",
    "real_data/BM24 Scoring Form 3 (Responses) - Form Responses 1.csv",
    "real_data/BM24 Scoring Form 4 (Responses) - Form Responses 1.csv",
    "real_data/BM24 Scoring Form 5 (Responses) - Form Responses 1.csv",
]
event_results_filename = "real_data/bm_results.csv" # output file
# ==============================================================================================
